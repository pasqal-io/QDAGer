...
# bash expes/launcher_1gpu_plain.sh --dataset aids
...
PY_CMD_BASE="python main.py"   # plain python -> no DDP init -> falls back to train_one_epoch()
...
# Add QDAGer/ to config path
CONFIG_PATH="configs/model_cfg/QDAGer/${SETTING}/${MODEL}_${DATASET}.yaml"
...
submit_one () {
  ...
  # Overwrites on reruns (same behavior as your original)
